...
%-------------------------------------------------------------------------
    perturb_sig_dir = [PATHS.raw_data_dir filesep 'perturbation-signals'];
    lat_per_file = [perturb_sig_dir filesep 'lateral-perturbation.txt'];
    perturbation_input = importdata(lat_per_file);
    mocap_file = [PATHS.raw_data filesep 'T006' filesep 'mocap-006.txt'];
