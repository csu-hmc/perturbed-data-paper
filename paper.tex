...
several studies on the CGA Normative Gait Database~\cite{Kirtley2014} and these
...
has a normative gait data set~\cite{Wilson2014} from 25 subjects with lower
...
%
The study was approved by the Institutional Review Board of Cleveland State
University (\# 29904-VAN-HS) and informed consent was obtained from all
participants.
...
The Cortex software delivers 3D marker trajectories from the cameras along with
data from force plates and analog sensors (EMG/Accelerometer) through a
National Instruments USB-6255 data acquisition unit. D-Flow is required to
collect data from any digital sensors and to control the treadmill's motion
(lateral, pitch, and belts). D-Flow can process the data in real time and/or
export data to file.
...
system. Figure~\ref{fig:treadmill} shows the layout of the equiptment.

\begin{figure*}
  \centering
  \includegraphics{figures/treadmill.png}
  \caption{The treadmill, cameras, projection screen, and saftey rope. The
    direction of travel is in the $-z$ direction.}
  \label{fig:treadmill}
\end{figure*}
